...
import { RowContentComponent } from 'src/app/second-option/row-content/row-content.component';
import { TableData } from 'src/app/second-option/table-data';

@Component({
  selector: 'app-second-option',
  templateUrl: './second-option.component.html',
  styleUrls: ['./second-option.component.css']
})
